...
object ClosureCleaner extends LazyLogging {
    private[neutrino] final val OUTER = "$outer"

    // Get an ASM class reader for a given class from the JAR that loaded it
    private[neutrino] def getClassReader(cls: Class[_]): ClassReader = {
...
private[neutrino] class ReturnStatementInClosureException
...
private[neutrino] case class MethodIdentifier[T](cls: Class[T], name: String, desc: String)
 ...
 */
private[neutrino] class FieldAccessFinder(
