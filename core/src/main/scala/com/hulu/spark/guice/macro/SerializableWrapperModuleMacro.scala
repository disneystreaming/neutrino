...
import com.hulu.guice.annotation.{ConcreteNestedAnnotation, NestedAnnotation}
import com.hulu.guice.typeLiteral
import com.hulu.spark.JAnnotation
    ...
    def withSerializableWrapperImpl[T: c.WeakTypeTag](c: whitebox.Context): c.Expr[ScalaLinkedBindingBuilder[T]] = {
        ...
        builder match {
            case q"$moduleBind($tt) $annotatedWith($at)" => {
                ...
                keyExpr = q"com.hulu.spark.guice.`macro`.SerializableWrapperModuleMacro.getKey[${weakTypeTag}]($at)"
            }
        ...
        c.Expr[ScalaLinkedBindingBuilder[T]](q"""
         def ${bindingMethod}(
            ...
            import com.hulu.spark.guice._
            import net.codingwell.scalaguice._
            import scala.reflect.runtime.universe._
            import com.hulu.spark.guice.serializableprovider.SerializableProvider
            import com.hulu.spark.util.ClosureCleaner

            val nestedAnnotation = com.hulu.spark.guice.`macro`.SerializableWrapperModuleMacro.getNestedAnnotation(key)
            ...
            install(new com.hulu.spark.guice.serializablewrapper.InnerPrivateModule[${weakTypeTag}](nestedKey, key, func))
